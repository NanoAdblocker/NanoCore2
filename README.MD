...
can be placed easily with the help of
...
2. Remove problematic content from UltimateMirror
...
2. Wait for GitCDN cache to expire (takes about 2 hours), then restart
   MirrorEngine
