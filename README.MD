...
4. Run `git clone --depth 1 https://github.com/gorhill/uBlock.git` in an
   ...
   appropriate.
5. Run these commands in an appropriate directory to get files needed to build
   Nano Core 2.
...
To fix conflict, either edit the patch file manually or disable the broken
patch along with patches after it and recreate the changes.
